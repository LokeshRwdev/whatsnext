...
function useTodayStats() {
    ...
    const load = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "useTodayStats.useCallback[load]": async ()=>{
            ...
            const end = new Date();
            const { data: trips, error: tripsError } = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$supabase$2d$browser$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["supabase"].from("trips").select("pickup_at,drop_at,fare_inr,tip_inr").gte("pickup_at", start.toISOString()).lte("pickup_at", end.toISOString());
            if (tripsError) {
            ...
            const { data: opsRow } = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$supabase$2d$browser$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["supabase"].from("ops_daily").select("idle_minutes").eq("day", start.toISOString().slice(0, 10)).maybeSingle();
            setStats({
                totalTrips,
                totalEarnings,
                totalHours,
...
_s(NavBar, "tvqYBgR03Z5YdJXpGy7YMP/NG5o=", false, function() {
    return [
...
//# sourceMappingURL=_b8d4b338._.js.map