...
"[project]/node_modules/@asteasolutions/zod-to-openapi/dist/index.mjs [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function extendZodWithOpenApi(zod) {
    ...
    zod.ZodType.prototype.openapi = function(refOrOpenapi, metadata) {
        ...
        const _g = openapi !== null && openapi !== void 0 ? openapi : {}, { param } = _g, restOfOpenApi = __rest(_g, [
            "param"
        ]);
        ...
        const result = new this.constructor(Object.assign(Object.assign({}, this._def), {
            openapi: Object.assign(Object.assign({}, Object.keys(_internal).length > 0 ? {
                _internal
            } : undefined), Object.keys(resultMetadata).length > 0 ? {
                ...
                extendedResult._def.openapi = {
                    _internal: {
                        extendedFrom: ((_b = (_a = this._def.openapi) === null || _a === void 0 ? void 0 : _a._internal) === null || _b === void 0 ? void 0 : _b.refId) ? {
                            refId: (_d = (_c = this._def.openapi) === null || _c === void 0 ? void 0 : _c._internal) === null || _d === void 0 ? void 0 : _d.refId,
                            schema: this
...
class OpenAPIRegistry {
     ...
     */ registerParameter(refId, zodSchema) {
        ...
        const schemaWithMetadata = schemaWithRefId.openapi(Object.assign(Object.assign({}, currentMetadata), {
            param: Object.assign(Object.assign({}, currentMetadata === null || currentMetadata === void 0 ? void 0 : currentMetadata.param), {
                name: (_c = (_b = currentMetadata === null || currentMetadata === void 0 ? void 0 : currentMetadata.param) === null || _b === void 0 ? void 0 : _b.name) !== null && _c !== void 0 ? _c : refId
            })
        }));
        this._definitions.push({
            type: 'parameter',
...
class Metadata {
    static getMetadata(zodSchema) {
        ...
        return {
            ...
            }, metadata === null || metadata === void 0 ? void 0 : metadata.metadata)
        };
    }
    ...
    static getParamMetadata(zodSchema) {
        ...
        return {
            ...
            metadata: Object.assign(Object.assign({}, metadata === null || metadata === void 0 ? void 0 : metadata.metadata), {
                ...
                param: Object.assign({
                    description: zodDescription
                }, (_b = metadata === null || metadata === void 0 ? void 0 : metadata.metadata) === null || _b === void 0 ? void 0 : _b.param)
            })
        };
    }
    /**
...
class ArrayTransformer {
    transform(zodSchema, mapNullableType, mapItems) {
        ...
        return Object.assign(Object.assign({}, mapNullableType('array')), {
            ...
            minItems: (_a = zodSchema._def.minLength) === null || _a === void 0 ? void 0 : _a.value,
...
class LiteralTransformer {
    transform(zodSchema, mapNullableType) {
        return Object.assign(Object.assign({}, mapNullableType(typeof zodSchema._def.value)), {
            enum: [
...
class NativeEnumTransformer {
    transform(zodSchema, mapNullableType) {
        ...
        return Object.assign(Object.assign({}, mapNullableType(type === 'numeric' ? 'integer' : 'string')), {
            enum: values
        });
    }
}
...
class ObjectTransformer {
    transform(zodSchema, defaultValue, mapNullableType, mapItem) {
        ...
        if (!extendedFrom) {
            return Object.assign(Object.assign(Object.assign(Object.assign({}, mapNullableType('object')), {
                properties,
    ...
    generateAdditionalProperties(zodSchema, mapItem) {
        ...
        return {
            additionalProperties: mapItem(catchallSchema)
        };
    }
...
class RecordTransformer {
    transform(zodSchema, mapNullableType, mapItem) {
        ...
        if (isZodType(keyType, 'ZodEnum') || isZodType(keyType, 'ZodNativeEnum')) {
            ...
            const properties = keys.reduce((acc, curr)=>Object.assign(Object.assign({}, acc), {
                    [curr]: propertiesSchema
                }), {});
            return Object.assign(Object.assign({}, mapNullableType('object')), {
                properties
            });
        }
        return Object.assign(Object.assign({}, mapNullableType('object')), {
...
class StringTransformer {
    transform(zodSchema, mapNullableType) {
        ...
        const maxLength = Number.isFinite(zodSchema.minLength) ? (_b = zodSchema.minLength) !== null && _b !== void 0 ? _b : undefined : undefined;
        const minLength = Number.isFinite(zodSchema.maxLength) ? (_c = zodSchema.maxLength) !== null && _c !== void 0 ? _c : undefined : undefined;
        return Object.assign(Object.assign({}, mapNullableType('string')), {
...
class OpenAPIGenerator {
    ...
    buildComponents() {
        ...
        return Object.assign(Object.assign({}, rawComponents), {
            schemas: Object.assign(Object.assign({}, (_a = rawComponents.schemas) !== null && _a !== void 0 ? _a : {}), this.schemaRefs),
    ...
    getParameterRef(schemaMetadata, external) {
        ...
        const existingRef = ((_b = schemaMetadata === null || schemaMetadata === void 0 ? void 0 : schemaMetadata._internal) === null || _b === void 0 ? void 0 : _b.refId) ? this.paramRefs[(_c = schemaMetadata._internal) === null || _c === void 0 ? void 0 : _c.refId] : undefined;
    ...
    generateInlineParameters(zodSchema, location) {
        ...
        const referencedSchema = this.getParameterRef(metadata, {
            in: location
        });
        if (referencedSchema) {
            return [
        ...
        if (isZodType(zodSchema, 'ZodObject')) {
            ...
            const parameters = Object.entries(propTypes).map(([key, schema])=>{
                ...
                return this.generateParameter(schema.openapi({
                    param: {
                        name: key,
                        in: location
                    }
        ...
        return [
            this.generateParameter(zodSchema.openapi({
                param: {
                    in: location
                }
            }))
    ...
    getRequestBody(requestBody) {
        ...
        const { content } = requestBody, rest = __rest(requestBody, [
            "content"
        ]);
    ...
    getParameters(request) {
        ...
        const queryParameters = enhanceMissingParametersError(()=>query ? this.generateInlineParameters(query, 'query') : [], {
            location: 'query'
        });
        const pathParameters = enhanceMissingParametersError(()=>params ? this.generateInlineParameters(params, 'path') : [], {
            location: 'path'
        });
        const cookieParameters = enhanceMissingParametersError(()=>cookies ? this.generateInlineParameters(cookies, 'cookie') : [], {
            location: 'cookie'
        });
    ...
    generatePath(route) {
        ...
        const parameters = enhanceMissingParametersError(()=>this.getParameters(request), {
            route: `${method} ${path}`
        });
    ...
    getResponse(response) {
        ...
        const { content, headers } = response, rest = __rest(response, [
            "content",
            "headers"
        ]);
        ...
        const responseHeaders = isZodType(headers, 'ZodObject') ? this.getResponseHeaders(headers) : // since this is the user's responsibility to keep it correct
        headers;
        return Object.assign(Object.assign(Object.assign({}, rest), {
    ...
    getBodyContent(content) {
        return mapValues(content, (config)=>{
            ...
            const { schema: configSchema } = config, rest = __rest(config, [
                "schema"
            ]);
...
class OpenApiGeneratorV30Specifics {
    ...
    mapNullableType(type, isNullable) {
        return Object.assign(Object.assign({}, type ? {
            type
        } : undefined), isNullable ? this.nullType : undefined);
    }
    mapTupleItems(schemas) {
        const uniqueSchemas = uniq(schemas);
        return {
            items: uniqueSchemas.length === 1 ? uniqueSchemas[0] : {
                anyOf: uniqueSchemas
            },
...
class OpenApiGeneratorV31 {
    ...
    generateDocument(config) {
        ...
        return Object.assign(Object.assign(Object.assign({}, config), baseDocument), {
...
//# sourceMappingURL=node_modules_542ec38f._.js.map