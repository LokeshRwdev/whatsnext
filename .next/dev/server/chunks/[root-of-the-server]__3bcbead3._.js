...
async function ingestRideEvent({ supabase, driverId, payload }) {
    ...
    const insertPayload = {
        ...
        fare_inr: payload.fare_inr ?? null,
        distance_km: payload.distance_km ?? null,
        pickup_zone: pickupZoneId,
        drop_zone: dropZoneId,
        pickup_loc: hasPickup ? toPointWkt(payload.pickup_lon, payload.pickup_lat) : null,
        drop_loc: hasDrop ? toPointWkt(payload.drop_lon, payload.drop_lat) : null
    };
...
async function POST(req) {
    try {
        ...
        const payload = __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$zod$2d$schemas$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["RideEventIngestSchema"].parse(await req.json());
        ...
        console.error("[ride-events/ingest] error", error);
...
//# sourceMappingURL=%5Broot-of-the-server%5D__3bcbead3._.js.map