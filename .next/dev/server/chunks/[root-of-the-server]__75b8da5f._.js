...
async function computeNextZonesForDriver(params) {
    ...
    const contextSnapshot = {
        ...
        bucket_start: bucketIso,
        bucket_label: bucketLabel,
        traffic_source: trafficSnapshot.source
    };
    return {
        computed_at: computedAt.toISOString(),
...
async function fetchCandidateZones(supabase, currentLoc) {
    ...
    for (const row of data){
        ...
        const distance = (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$server$2f$geo$2d$utils$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["distanceKm"])(currentLoc.lat, currentLoc.lon, row.lat, row.lon);
...
async function POST(req) {
    try {
        ...
        const payload = __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$zod$2d$schemas$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["CreatePingReq"].parse(await req.json());
        ...
        if (pingError) {
            console.error("[pings] insert failed", {
                driverId: user.id,
                error: pingError
            });
            return (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$api$2d$respond$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["bad"])("Failed to save ping", null, 500, "DB_ERROR");
        }
        ...
        const { error: stateError } = await supabase.from("driver_state").upsert({
            driver_id: user.id,
            last_ping_at: tsIso,
            loc: (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$server$2f$geo$2d$utils$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["pointFromLatLon"])(payload.lat, payload.lon),
            snapped_zone: snappedZoneId,
            speed_kmh: payload.speed_kmh ?? null,
            battery_pct: payload.battery_pct ?? null,
            recommendation,
        ...
        if (stateError) {
            console.error("[pings] driver_state upsert failed", {
                driverId: user.id,
                error: stateError
            });
        }
...
async function GET(req) {
    try {
        const { supabase } = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$auth$2d$guard$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["requireUser"])(req);
        const url = new URL(req.url);
        const limit = Math.min(parseInt(url.searchParams.get("limit") || "50", 10), 200);
        const { data, error } = await supabase.from("pings").select("id,lat,lon,recorded_at,speed_kmh,battery_pct").order("recorded_at", {
            ascending: false
        }).limit(limit);
        ...
        if (e.message === "Unauthorized") return (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$api$2d$respond$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["bad"])("Unauthorized", null, 401, "UNAUTHORIZED");
        return (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$api$2d$respond$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["bad"])("Unexpected error", null, 500, "INTERNAL_ERROR");
    }
}
}),
...
//# sourceMappingURL=%5Broot-of-the-server%5D__75b8da5f._.js.map