...
function LoginPage() {
    ...
    const handleSubmit = async (event)=>{
        ...
        setSubmitting(false);
        if (error) {
            const message = error.message?.toLowerCase().includes("invalid login") || error.status === 400 ? "Invalid email or password" : error.message ?? "Unable to sign in";
            setError(message);
            return;
        }
...
//# sourceMappingURL=%5Broot-of-the-server%5D__3edb4efb._.js.map