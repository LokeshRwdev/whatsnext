...
"[project]/hooks/useZones.ts [app-ssr] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function readCachedZones(db, key) {
    try {
        return await db.get(STORE_ZONES, key) ?? null;
    } catch (error) {
        console.warn("[useZones] failed to read cache", error);
        return null;
    }
}
async function writeCachedZones(db, key, zones) {
    try {
...
function useZones() {
    ...
    const dbRef = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useRef"])(null);
    const fetchedOnceRef = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useRef"])(false);
    const fetchZones = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useCallback"])(async (opts)=>{
        if (!opts?.background) {
            setLoading(true);
        }
        try {
            ...
            if (!res.ok || !payload) {
                throw new Error(payload?.error?.message ?? res.statusText ?? "Failed to fetch zones");
            }
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useEffect"])(()=>{
        ...
        (async ()=>{
            ...
            if (cached && cached.length > 0) {
                setZones(cached);
                setLoading(false);
                console.log("[useZones] cache_hit", {
                    count: cached.length
                });
                fetchZones({
                    background: true
    ...
    const refetch = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useCallback"])(()=>fetchZones(), [
        fetchZones
    ]);
    return {
        zones,
...
function RootLayout({ children }) {
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$hooks$2f$useZones$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useZones"])();
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useEffect"])(()=>{
...
//# sourceMappingURL=%5Broot-of-the-server%5D__175a408b._.js.map