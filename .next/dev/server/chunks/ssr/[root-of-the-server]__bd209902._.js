...
function SignupPage() {
    ...
    const handleSubmit = async (event)=>{
        ...
        if (error) {
            const friendly = error.message?.toLowerCase().includes("already registered") || error.status === 400 ? "This email is already registered. Try logging in instead." : error.message ?? "Unable to sign up";
            setError(friendly);
            setSubmitting(false);
            return;
        }
...
//# sourceMappingURL=%5Broot-of-the-server%5D__bd209902._.js.map