...
async function GET() {
    ...
    try {
        ...
        userId = user.id;
        const { data, error, status } = await supabase.from("driver_state").select("driver_id,last_ping_at,lat,lon,snapped_zone_id,speed_kmh,battery_pct,recommendation,updated_at")// driver_state rows are keyed by driver_id via RLS (auth.uid())
...
//# sourceMappingURL=%5Broot-of-the-server%5D__b52d703a._.js.map